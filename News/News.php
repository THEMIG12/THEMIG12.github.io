...
<html>
    ...
    <link rel="icon" href="Pics/Logo.webp" type="image/x-icon">
        ...
        .moonphase-container {
            display: flex;
            align-items: right; /* Vertically center align */
        }
...
.square-block {
    width: 350px; /* Adjust the width for larger squares */
    height: 400; /* Same as the width to create a square */
    margin: 10px; /* Adjust the margin for closer spacing */
    background-color: rgb(24, 24, 24,0.5); /* Background color for the blocks */
...
main {
    ...
    <ul class="nav">
        ...
        if (isset($_SESSION['name'])) {
            ...
            ?>
            <li class="navbuttons"><a href="" class="active">الأخبار</a></li>
            ...
            ?>
            <li class="navbuttons"><a href="../News/News.php" class="active">الأخبار</a></li>
            <li class="navbuttons"><a href="../About/About.php">حول</a></li>
            <li class="navbuttons li-right"><a href="../Contact Us/Contact Us.php">تواصل معنا</a></li>
            <li class="navbuttons dropdown">
                <li class="dropdown"> 
    ...
    <br><br><br><br><br><br>
    <?php
$rss_url = "https://www.nasa.gov/rss/dyn/spacetoground_vodcast.rss"; // Replace with your RSS feed URL
$xml = simplexml_load_file($rss_url);

if ($xml) {
    echo '<div class="nasa-feed">';
    ...
    echo "Unable to retrieve NASA RSS feed.";
}
?>
